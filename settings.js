const settings = {
    ...
    "port": 12345, // set to -1 to automatically scan for open ports
    ...
    "spawn_timeout": 120, // num seconds allowed for the bot to spawn before throwing error. Increase when spawning takes a while.
